...
namespace M_SAVA_DAL.Migrations
{
    ...
    [Migration("20250710212109_YourMigrationName")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("M_SAVA_DAL.Models.SavedFileDataDB", b =>
                {
                    ...
                    b.PrimitiveCollection<IQueryable<string>>("Categories")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.PrimitiveCollection<IQueryable<string>>("Tags")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("M_SAVA_DAL.Models.AccessGroupDB", b =>
                {
                    b.HasOne("M_SAVA_DAL.Models.AccessCodeDB", "AccessCode")
                        .WithMany()
