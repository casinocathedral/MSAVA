        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SavedFiles_AccessGroups_AccessGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FileDatas_SavedFiles_FileReferenceId",
                        column: x => x.FileReferenceId,
                        principalTable: "SavedFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FileDatas_Users_LastModifiedById",
                        column: x => x.LastModifiedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FileDatas_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileDatas_FileReferenceId",
                table: "FileDatas",
                column: "FileReferenceId");

            migrationBuilder.CreateIndex(
                name: "IX_FileDatas_LastModifiedById",
                table: "FileDatas",
                column: "LastModifiedById");

            migrationBuilder.CreateIndex(
                name: "IX_FileDatas_OwnerId",
                table: "FileDatas",
                column: "OwnerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedFiles_AccessGroupId",
                table: "SavedFiles",
